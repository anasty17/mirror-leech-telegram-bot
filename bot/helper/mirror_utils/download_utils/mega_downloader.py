...
def add_mega_download(mega_link: str, path: str, listener):
    ...
    if mega_listener.error is not None:
        return sendMessage(str(mega_listener.error), listener.message)
    if STOP_DUPLICATE and not listener.isLeech:
        ...
        if mname is not None:
            ...
            if smsg:
                ...
                return sendMarkup(msg1, listener.message, button)
    if any([STORAGE_THRESHOLD, ZIP_UNZIP_LIMIT, MEGA_LIMIT]):
        ...
        if STORAGE_THRESHOLD is not None:
            ...
            if not acpt:
                ...
                return sendMessage(msg, listener.message)
        limit = None
        ...
        if limit is not None:
            ...
            if size > limit * 1024**3:
                return sendMessage(msg3, listener.message)

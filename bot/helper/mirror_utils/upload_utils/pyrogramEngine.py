...
from os import path as ospath, walk, remove as osremove, rename as osrename
from bot import (
    AS_DOCUMENT, AS_DOC_USERS, DOWNLOAD_DIR, AS_MEDIA_USERS, CUSTOM_FILENAME,
    app)
from bot.helper.ext_utils.fs_utils import (
    take_ss, get_path_size, get_media_info, get_video_resolution)

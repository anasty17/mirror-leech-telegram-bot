...
def start(update, context):
    ...
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'This bot can mirror direct download link has supported to Google Drive or Telegram. Type /{BotCommands.HelpCommand} to get a list of available commands.'

...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, shell, eval, delete, count, leech_settings, search, rss, shorten
...
<br><br>
<b>/{BotCommands.ShortenLinkCommand}</b>: Shorten long url to short url
'''
...
botcmds = [
        ...
        (f'{BotCommands.ShortenLinkCommand}','Shorten URL')
    ]
